...
public class Zahtev implements Serializable
{
    ...
    public Zahtev(int zahtevID, Date datumVremeTestiranja, int hitno, String tip, String rezultat, Date datumVremeRezultata, String napomena, String status, OsiguranoLice osiguranoLice, Laboratorija laboratorija, Laborant laborant) {
    ...
    public String toString() {
        return "Zahtev{" + "zahtevID=" + zahtevID + ", datumVremeTestiranja=" + datumVremeTestiranja + ", hitno=" + hitno + ", tip=" + tip + ", rezultat=" + rezultat + ", datumVremeRezultata=" + datumVremeRezultata + ", napomena=" + napomena + ", status=" + status + ", osiguranoLice=" + osiguranoLice + ", laboratorija=" + laboratorija + ", laborant=" + laborant + '}';
    }
